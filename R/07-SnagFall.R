...
sl_adult <- sl_out_as[state_type=="Adult", .N, by=.(Treatment, Unit, Species, timestep)]
setnames(sl_adult, "N", "NumAdult")
sl_snag <- sl_out_as[state_type=="Snag", .N, by=.(Treatment, Unit, Species, timestep)]
setnames(sl_snag, "N", "NumExistSnags")
sl_snagcreate <- sl_out_as[state_type=="SnagCreate", .N, by=.(Treatment, Unit, Species, timestep)]
setnames(sl_snagcreate, "N", "NumSnagCreate")
sl_snagfall <- sl_out_as[state_type=="SnFallNext", .N, by=.(Treatment, Unit, Species, timestep)]
setnames(sl_snagfall, "N", "NumSnagFall")
...
sl_ad_sn_sp <- sl_ad_sn_sp[,.(NumAdult, NumExistSnags, NumSnagCreate, NumSnagFall,
                              SnagRecrRate = ifelse(NumSnagCreate == 0,0,
                                                    (NumSnagCreate/(NumAdult+NumSnagCreate))*100), 
                              SnagFallRate = ifelse(NumSnagFall == 0,0, 
                                                    (NumSnagFall/(NumExistSnags + NumSnagCreate 
...
setnames(dc_adult, "N", "NumAdult")
dc_snag <- dc_out_as[state_type=="Snag", .N, by=.(Treatment, Unit, Species, timestep)]
setnames(dc_snag, "N", "NumExistSnags")
...
dc_ad_sn_sp <- dc_ad_sn_sp[,.(NumAdult, NumExistSnags, NumSnagCreate, NumSnagFall,
                        SnagRecrRate = ifelse(NumSnagCreate == 0,0,
                                              (NumSnagCreate/(NumAdult+NumSnagCreate))), 
                        SnagFallRate = ifelse(NumSnagFall == 0,0, 
                                          (NumSnagFall/(NumExistSnags + NumSnagCreate 
                                                        + NumSnagFall)))),
                     by=c("Treatment","Unit","timestep","Species")]
