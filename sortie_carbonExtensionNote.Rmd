...
```{r}
#I'm assuming we only need these scripts if you want to run all the calculations? - AC
# Yup that's correct! - LW
...
DC_rss <- with(final_DC_L_C_u, sum((C_unit - field_C)^2))
DC_rmse <- with(final_DC_L_C_u, sqrt(mean((C_unit - field_C)^2)))
