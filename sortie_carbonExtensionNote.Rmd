...
### Field ###
# LIVE
DC_field_L_C <- read.csv(paste0(path_outputs, "csv/DateCreek_C_field_L.csv")) # DC = Date Creek, L = 

# Live - Western red cedar (Cw)
DC_field_L_C_Cw <- read.csv("./Outputs/csv/DateCreek_2018_field_C_unit_L_Cw.csv")

# Live - Western hemlock (Hw)
DC_field_L_C_Hw <- read.csv("./Outputs/csv/DateCreek_2018_field_C_unit_L_Hw.csv")



# DEAD
DC_field_D_C <- read.csv(paste0(path_outputs, "csv/DateCreek_C_field_D.csv")) # DC = Date Creek, L = 
